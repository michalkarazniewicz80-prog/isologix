// netlify/functions/loadDrafts.js
...
exports.handler = async (event) => {
  try {
    ...
    const url = `${SUPABASE_URL}/rest/v1/iso_drafts?user_id=eq.${encodeURIComponent(user_id)}&select=id,title,data,updated_at&order=updated_at.desc`;
